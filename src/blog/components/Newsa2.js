...
export default function Newsa2() {
    ...
    return (
        <div className={classes.root}>
            <CardHeader
                avatar={
                    <Avatar aria-label="recipe" src={ava2} className={classes.avatar}/>
                ...
                title="Диденко Валентин Юрьевич"
                subheader="Аспирант СПбГТи на кафедре Теоретической биологии"
            />
            <Divider/>
            <Typography style={{margin: 20}} component="h5" variant="h5">
                Нервные окончания низших растений
            </Typography>
            ...
            <CardMedia
                ...
                image="https://ak.picdn.net/shutterstock/videos/20215024/thumb/1.jpg"
                title="Paella dish"
            />
            <CardContent>
